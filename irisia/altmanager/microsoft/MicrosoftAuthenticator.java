 ...
 */
package irisia.altmanager.microsoft;
...
import irisia.altmanager.microsoft.model.request.MinecraftLoginRequest;
import irisia.altmanager.microsoft.model.request.XSTSAuthorizationProperties;
import irisia.altmanager.microsoft.model.request.XboxLiveLoginProperties;
import irisia.altmanager.microsoft.model.request.XboxLoginRequest;
import irisia.altmanager.microsoft.model.response.MicrosoftRefreshResponse;
import irisia.altmanager.microsoft.model.response.MinecraftLoginResponse;
import irisia.altmanager.microsoft.model.response.MinecraftProfile;
import irisia.altmanager.microsoft.model.response.MinecraftStoreResponse;
import irisia.altmanager.microsoft.model.response.XboxLoginResponse;
