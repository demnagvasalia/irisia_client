...
public class RoundedHelper {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("shader/roundRectOutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("shader/roundRectTextured.frag");
    ...
    public static void drawHalfRound(float x, float y, float width, float height, float radius, boolean blur, Color color) {
        resetColor();
        GlStateManager.enableBlend();
        GlStateManager.blendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
        roundedShader.init();
