...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            Irisia.getInstance.instanceCollection.getBus().publish(eventTick);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        for(Module m :  Irisia.getInstance.instanceCollection.getModuleManager().getModules()){
                            if(m.getKeyBind() == k)
                                m.toggle();
                        }
                        if (k == 1)
