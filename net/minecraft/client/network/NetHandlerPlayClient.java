...
import irisia.event.system.impl.EventPacketSend;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
        EventPacketSend eventPacketSend = new EventPacketSend(p_147297_1_);
        Irisia.getInstance.getInstanceCollection().getBus().publish(eventPacketSend);
        if(!eventPacketSend.isCancelled()){
            this.netManager.sendPacket(p_147297_1_);
        }
    }
    public void addToSendQueueDirect(Packet p_147297_1_)
    {
        this.netManager.sendPacket(p_147297_1_);
    }
