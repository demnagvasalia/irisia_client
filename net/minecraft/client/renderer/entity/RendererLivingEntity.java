...
import irisia.module.impl.render.Chams;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
        Chams chams = (Chams) Irisia.getInstance.getInstanceCollection().getModuleManager().getModuleByName("Chams");
        if(chams.isToggled() && chams.player.isEnabled() && entity instanceof EntityPlayer) {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (flag || flag1) {
            ...
            Chams chams = (Chams) Irisia.getInstance.getInstanceCollection().getModuleManager().getModuleByName("Chams");
            if(chams.isToggled() && entitylivingbaseIn instanceof EntityPlayer && chams.opacity.getValue() > 0) {
                if(chams.player.isEnabled())
                    this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                int color = new Color(chams.red.getValueInteger(), chams.green.getValueInteger(), chams.blue.getValueInteger()).getRGB();
                int alpha = chams.opacity.getValueInteger();
                boolean material = chams.material.isEnabled();
                ...
                color = new Color(chams.red.getValueInteger(), chams.green.getValueInteger(), chams.blue.getValueInteger()).getRGB();
                GL11.glColor4f((float)((float)(color >> 16 & 0xFF) / 255.0f), (float)((float)(color >> 8 & 0xFF) / 255.0f), (float)((float)(color & 0xFF) / 255.0f), (float)Math.max(0.11764706f, (float)alpha / 255.0f));
                this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                if (!material) {
                    GlStateManager.enableLighting();
