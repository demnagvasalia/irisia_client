...
public abstract class EntityPlayer extends EntityLivingBase
{
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            handle:
                            {
                                ...
                                final KillAura aura = (KillAura) Irisia.getInstance.getInstanceCollection().getModuleManager().getModuleByName("Kill Aura");

                                if(!aura.keepSprintProperty.isEnabled()) {
    ...
    public void setFakeItemInUse(ItemStack stack, int duration)
    {
        if (stack != this.itemInUse)
        {
